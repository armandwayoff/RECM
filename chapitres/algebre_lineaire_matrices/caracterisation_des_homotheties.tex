...
\begin{preuve}
    ...
    \begin{itemize}
        ...
        \item[$(\Leftarrow)$] \marginnote[0cm]{Source : \href{http://marocprepa.com/site/homothetiecarac}{Une caractérisation des homothéties -- \textsf{marocprepa.com}}} On suppose que la famille $\big(x, f(x) \big)$ est liée pour tout $x \in E$. On pose 
