...
\begin{solution}
    \source{\cite{maths-france} Planche no 5. Réduction. Corrigé}
    \begin{itemize}
...
\begin{solution}
    \begin{enumerate}
        ...
        \item \source{\cite{reduc_des_endo} p. 117}
        ...
        \begin{lemme}
            \source{\cite{reduc_des_endo} p. 33}
...
\begin{exercice}
    \source{\href{http://exo7.emath.fr/ficpdf/fic00118.pdf}{Exercices de J.-L. \textsc{Rouget} (fic00118 exo 28)}}
...
\begin{exercice}
    \source{\cite{maths-france} Planche no 2. Révisions algèbre linéaire. Espaces vectoriels}
