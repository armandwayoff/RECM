...
\section{Matrices de taille $3$ d'ordre de nilpotence égal à $2$} \labsec{matrices_de_taille_trois_odre_de_nilpotence_deux}
...
\section{Titre à compléter} \labsec{titre_a_completer}
\begin{exercice}
    \cite{acamanes} 
