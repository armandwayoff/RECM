...
\begin{solution}
    ...
    \begin{itemize}
        ...
        \marginnote[0cm]{
            L'ensemble $\mathcal{T}$ est engendré par
        ...
        Ainsi l'espace $\Vect(\mathcal{N})$ contient $F_i + \mathrm{E}_{1i} - \mathrm{E}_{i1} = \mathrm{E}_{11}-\mathrm{E}_{ii}$ pour $2 \leqslant i \leqslant n$ (puisque les trois matrices du membre de droite sont nilpotentes) et donc l'espace des matrices diagonales de trace nulle. 
    \end{itemize}
