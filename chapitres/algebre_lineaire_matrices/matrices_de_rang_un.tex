\begin{prop} \labprop{caracterisation_matrice_de_rang_1}
...
\begin{remarque}
    Par contre, il n'y a pas unicité du couple $(X, Y)$. En effet si ce couple convient, le couple $(2X, \frac{1}{2}Y)$ convient aussi.
\end{remarque}
