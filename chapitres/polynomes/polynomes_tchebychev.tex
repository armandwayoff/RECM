\begin{defi}[Polynômes de \nom{Tchebychev}]
    Les \emph{polynômes de \nom{Tchebychev}} de première espèce sont les uniques polynômes $(\Tcheby_n)_{n \geqslant 0}$ définis sur $]-1, 1[$ par
...
\begin{marginfigure}[-4.5cm]
    \centering
	\input{chapitres/polynomes/illustrations/i_polynomes_tchebychev}
	\caption*{\centering Polynômes de \nom{Tchebychev} de première espèce}
	\begin{align*}
...
\marginnote[-6cm]{
    \begin{prop}[Formule de trigonométrie]
