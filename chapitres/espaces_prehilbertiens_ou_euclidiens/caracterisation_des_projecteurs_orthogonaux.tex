...
\begin{preuve}
    \begin{itemize}
        ...
        \item[$(\Leftarrow)$]
        \begin{itemize}
            \item \marginnote[0cm]{Source : Exos incontournables SUP} Raisonner par l'absurde. Soit $F$ et $G$ tels que $p$ soit la projection sur $F$ parallèlement à $G$. Considérer un vecteur de $G^\perp \setminus F$ et aboutir à une contradiction.
            \item \marginnote[0cm]{Source : Ellipses p.176} Soit $p$ une projection telle que pour tout $x \in E, \norme{p(x)} \leqslant \norme{x}$. \\
