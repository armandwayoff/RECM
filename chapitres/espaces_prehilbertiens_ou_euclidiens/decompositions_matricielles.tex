...
\begin{prop}
    Soient $n \in \Ne$ et $M \in \Gl_n(\R)$. Il existe un unique couple $(T, O)$ tel que:
    $$M = OT,$$
...
\begin{preuve}
    \begin{itemize}
        ...
        On note $\mathscr{B}$ la base canonique de $\R^n$. Soit $\mathscr{C} \defeq (C_1, \dots, C_n)$ la famille des vecteurs colonnes de $M$ exprimés dans $\mathscr{B}$. Comme $M$ est inversible, $\mathscr{C}$ forme une base de $\R^n$. Appliquons-lui le procédé d'orthonormalisation de \textsc{Gram}-\textsc{Schmidt}. \\
