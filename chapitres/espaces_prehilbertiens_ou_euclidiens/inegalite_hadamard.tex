...
\begin{exercice}    
\marginnote[0cm]{Source : exercice 4, TD 14 \cite{acamanes}}
\begin{enumerate}
    ...
    \marginnote[-2cm]{
    	\begin{prop}{Inégalité arithmético-géométrique}
