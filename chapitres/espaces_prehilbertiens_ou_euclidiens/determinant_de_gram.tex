...
Jérôme Von Buhren \\
    ...
    \underline{Hérédité:} supponsons $\mathscr{P}_n$ vraie. Soit $(x_1, \dots, x_n, x_{n+1})$ une famille libre de $E$. En notant $F \defeq \Vect(x_1, \dots, x_n)$, il existe $(f, \tilde{f}) \in F \times F^\perp$ tel que $x_{n+1} = f + \title{f}$. Par le theorème (\nameref{distance_a_un_sous_espace_vectoriel}) et par $\mathscr{P}_n$, 
