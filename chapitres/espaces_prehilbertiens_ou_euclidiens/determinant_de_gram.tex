...
\begin{preuve}
    ...
    \end{align*}
    \marginnote[0cm]{
        On écrit la dernière colonne sous la forme
        $$
        \begin{pmatrix}
...
\begin{preuve}
    ...
    \begin{itemize}
        ...
        \item[$\rhd$] Hérédité: supponsons $\mathscr{P}_n$ vraie. Soit $(x_1, \dots, x_n, x_{n+1})$ une famille libre de $E$. En notant $F \defeq \Vect(x_1, \dots, x_n)$, il existe $(f, g) \in F \times F^\perp$ tel que $x_{n+1} = f + g$. Par le théorème (\nameref{distance_a_un_sous_espace_vectoriel}) et par $\mathscr{P}_n$, 
