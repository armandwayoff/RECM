...
\todoinline{Il faudrait dessiner aussi en bleu la version horizontale de l'aire (celle comprise entre les ordonnées f(a) et f(b) et la courbe rouge. On "verrait" alors le rectangle de base b et hauteur f(b) auquel on a enlevé le rectangle de base a et de hauteur f(a). Je sais pas si je suis clair\ldots}
