...
\todoinline{Regrouper au début du chapitre les intégrales sur un segment ?}

\todoinline{Note pour plus tard : dans la partie dérivation, il y a les contrôles des dérivées étudiées dans le problème Centrale Supélec - PC 1 - 2001}
