...
\begin{prop}[Intégrale d'\textsc{Euler}]
\[
...
\begin{exercice}[Intégrale d'\textsc{Euler}, Oraux - CCP-PSI-2016]\label{exercice:integraleEuler}
...
\todoinline{Fait, c'était effectivement un équivalent qu'il fallait et non un $o$. Tu es d'accord ?}
