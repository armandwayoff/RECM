...
\begin{marginfigure}[0cm]
    \input{chapitres/integration/illustrations/i_05-integrale_trigonometrique}
\end{marginfigure}
...
\[
\ln(\sin x) = \ln\mathopen{}\big(x + \petito(x)\big) = \ln(x) + \ln\mathopen{}\big(1 + \petito(1)\big) \sim_0 \ln x.
\]
...
De plus, $\frac{x \ln(x)}{(1+x^2)^2} = \petito\limits_{+\infty}\mathopen{}\left( \frac{1}{x^2} \right)$.
...
Dans la seconde intégrale, on effectue le changement de variable $\fonction[\varphi]{\interfo{1}{+\infty}}{\interof{0}{1}}{u}{\frac{1}{u}}$ qui est bien $\Cont^1$ et bijectif :
\begin{align*}
\int_0^{+\infty} \frac{x \ln(x)}{(1 + x^2)^2} \d x
