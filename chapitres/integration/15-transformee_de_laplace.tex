...
\item Montrer que
\[
\lim_{t\to+\infty} \sqrt{t} \int_1^{+\infty} \e^{-t x^2} f(t) \dt = 0.
\]
...
\item De plus,
\begin{align*}
\module{\int_1^{+\infty} \e^{-t x^2} f(t) \dt}
&\leq \e^{-t} \int_1^{+\infty} \module{f(t)} \dt.
\end{align*}
...
\[
\lim_{t\to+\infty} \sqrt{t} \int_0^{+\infty} \e^{-t x^2} f(t) \dt = f(0) \int_0^{+\infty} \e^{-u^2} \du.
\]
