\section{Intégrale de \textsc{Gauss}}\label{sec:intGauss}
...
\item \marginnote[-7pt]{\theoremeutilise{Inégalité de convexité du logarithme}}En utilisant l'inégalité de convexité du logarithme, pour $x \in \interff{0}{n}$,
\[
g_n(x)
...
%-----------
\subsection{La transformée de \textsc{Fourier} d'une gaussienne est une gaussienne}
...
\begin{figure}
    ...
    \caption{Transformées de \textsc{Fourier} de distributions gaussiennes \todoarmand{Changer les notations pour coller avec l'exercice}}
\end{figure}
