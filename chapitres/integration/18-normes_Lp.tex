...
\begin{solution}
\begin{reponses}
\item Comme $g$ est dérivable, d'après le \theoremeutilise{théorème de \nom{Taylor}--\nom{Young}}{theo:tayloryoung}, $g(y) = 1 + y g'(0) + o(y)$. Ainsi,
\begin{align*}
...
D'après le \theoremeutilise{théorème de dérivation sous le signe intégral}{theo:derivationsoussigneintegrale}, la fonction $I$ est dérivable sur $[0, 1[$ et
\begin{align*}
