...
D'après le \theoremeutilise{théorème de prolongement des dérivées}{thm:prolongementDesDerivees}, $\varphi_n$ est prolongeable en une fonction de classe $\mathscr{C}^1$ sur $\interfo{0}{1}$.
