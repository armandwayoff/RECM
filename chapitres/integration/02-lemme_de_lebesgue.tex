...
\begin{exercice}
\begin{enumerate}
\item Pour le premier point du lemme, utiliser une intégration par parties avec les fonctions $f$ et $x \mapsto \frac{\cos(\lg x)}{\lg}$·
...
\begin{solution}
    \begin{enumerate}
        ...
        \todoinline{j'ai fait passer le $\varphi$ dans l'intégrale à la ligne suivante. Si tu confirmes, tu peux supprimer cette remarque.}
        \[
...
\marginnote[-7pt]{\theoremeutilise{\hyperref[thm:prolongementDesDerivees]{Théorème de prolongement des dérivées}} \todoarmand{Mettre en évidence les théorèmes / prop. utilisés ?}}
\todoinline{Le mieux serait de générer un index je pense}
