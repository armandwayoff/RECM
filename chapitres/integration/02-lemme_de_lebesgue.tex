...
\begin{marginfigure}[-3cm]
    ...
    \ref{poly} $t \mapsto f(t) \sin(\lambda t)$, \ref{pmf} $\pm f$ \todoarmand{titre à modifier et figure un peu trop "lourde"}}
\end{marginfigure}
...
\begin{solution}
    \begin{reponses}
        ...
        Soit $\varepsilon > 0$. D'après le \theoremeutilise{théorème d'approximation par des fonctions en escalier}{theo:approximationescalier}, il existe une fonction en escalier $\varphi$ telle que $\|f - \varphi\|_\infty \leqslant \varepsilon$. De plus, d'après le point précédent, il existe un réel $\lambda_0$ strictement positif tel que pour tout $\lambda > \lambda_0$,
        \[
...
D'après le \theoremeutilise{théorème de prolongement des dérivées}{theo:prolongementDesDerivees}, $\varphi_n$ est prolongeable en une fonction de classe $\mathscr{C}^1$ sur $\interfo{0}{1}$.
