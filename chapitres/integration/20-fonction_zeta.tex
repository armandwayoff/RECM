\section{Prolongement de la zêta de \textsc{Riemann}par une intégrale}

\todoinline{Fonction $\sinc$ et séries entières déplacée dans séries entières car pas d'intégrales.\\
Section suivante sur Euler commentée car déjà présente ailleurs.}

\todoinline{Titre modifié - On pourrait également déplacer cette partie dans les séries de fonctions}
...
\todoinline{Pointer vers Rudin Ex.16 p.131}
