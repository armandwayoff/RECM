...
\draw[fill=mylightblue] (1,0)--(1,{f(1)})--(2,{f(2)})--(2,0);
\draw[fill=mylightblue] (2,0)--(2,{f(2)})--(3,{f(3)})--(3,0);
\draw[fill=mylightblue] (3,0)--(3,{f(3)})--(4,{f(4)})--(4,0);
\draw[fill=mylightblue] (4,0)--(4,{f(4)})--(5,{f(5)})--(5,0);

\draw[thick, myred] (2,{f(2)})--(3,{f(3)}) node[midway,above] {$\phi_1$};
