...
\draw[fill=mylightblue] (1,0) rectangle (2,{f(1)});
\draw[fill=mylightblue] (2,0) rectangle (3,{f(2)});
\draw[fill=mylightblue] (3,0) rectangle (4,{f(3)});
\draw[fill=mylightblue] (4,0) rectangle (5,{f(4)});
%\draw (5,0)--(5,{f(5)});
