...
\begin{marginfigure}[-8cm]
    \centering
    \input{chapitres/integration/illustrations/i_16-un_developpement_asymptotique}
    \caption{Représentation graphique de la fonction $F$ et des premiers termes de son développement asymptotique en $+\infty$}
\end{marginfigure}
\begin{marginfigure}[-1cm]
    \centering
    \input{chapitres/integration/illustrations/i_16-un_developpement_asymptotique_en0}
