...
\marginnote[0cm]{\url{https://fr.wikipedia.org/wiki/Intégrale_de_Gauss#Calcul_de_l'intégrale_de_Gauss}}

$$\Gamma \left( \frac{1}{2} \right) = \int_0^{+ \infty} t^{\frac{1}{2}-1} \me^{-t} \d t = 2 \int_0^{+ \infty} \me^{-u^2} \d u = \int_{- \infty}^{+ \infty} e^{-u^2} \d u.$$
