...
\todoinline{À déplacer dans séries numériques ? - Lier avec la formule de Stirling}
...
\item Si $a_n \sim b_n$ sont positifs et les termes généraux de séries convergentes, alors $\sum\limits_{k=n+1}^{+\infty} a_k \sim \sum\limits_{k=n+1}^{+\infty} b_k$.
