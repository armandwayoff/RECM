...
\marginnote[0cm]{
Les intégrales de \textsc{Wallis} ont été introduites par John \textsc{Wallis} (1616--1703), notamment pour développer le nombre $\pi$ en un produit infini de rationnels; le \textsl{produit de \textsc{Wallis}}, énoncé en 1656 dans son ouvrage \emph{Arithmetica infinitorum}. \href{https://fr.wikipedia.org/wiki/Intégrale_de_Wallis}{Source}.
}

\begin{defi}{Intégrale de \textsc{Wallis}}
Pour tout entier naturel $n$, on nomme \definir{intégrale de \textsc{Wallis}} l'intégrale définie par
\[
...
\begin{theo}{} \labprop{prop_wallis} Pour tout $n$ entier naturel, les intégrales de \textsc{Wallis} vérifient les propriétés suivantes
...
\marginnote[2cm]{Exercice inspiré de l'article \href{https://math-os.com/coefficient-binomial-central/}{Coefficient Binomial Central : un aperçu} (Annexe 2) du site \href{https://math-os.com/bienvenue/}{math-os.com} de René \textsc{Adad}}
\begin{exercice}
...
\item d'après le théorème des séries alternées, $\abs{f_n} \leqslant \abs{\cos(\,\cdot\,)^{n+1}} \leqslant 1$, la fonction constante égale à $1$ étant intégrable sur $\interff{0}{\pi/2}$.
\end{itemize}
