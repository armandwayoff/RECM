...
\]
Ainsi, d'après le \theoremeutilise{théorème des séries alternées}{thm:seriesAlternees}, $\sum u_n$ converge.
...
\end{align*}
Ainsi, $\lim_{x\to0} f'(x) = -\frac{1}{24}$. D'après le \theoremeutilise{théorème de prolongement dérivable}{thm:prolongementderivable}, la fonction $f$ est prolongeable en une fonction de classe $\mathscr{C}^1$ sur $\interff{0}{\pi}$.
...
\end{align*}
Ainsi, d'après le \theoremeutilise{théorème de dérivation sous le signe intégral}{thm:derivsousintegrale}, la fonction $g$ est de classe $\mathscr{C}^2$ sur $\Rpe$ et
\begin{align*}
g''(x)
...
\item Comme $\abs{\frac{\e^{-x t}}{t^2 + 1}} \leqslant \frac{1}{1 + t^2}$, d'après le \theoremeutilise{théorème de convergence dominée}{thm:convdominee},
\[
