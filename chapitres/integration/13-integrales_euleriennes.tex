...
\todoinline{Je garde pour plus tard ! On met une citation ? J'ai l'impression que c'est American Monthly ?}
...
\todoinline{Il faudrait clarifier le lien entre fonction Gamma d'Euler et fonction Beta, comme fait dans la relation suivante. D'autant que les paramètres ne sont pas entiers contrairement aux parties précédentes.}
