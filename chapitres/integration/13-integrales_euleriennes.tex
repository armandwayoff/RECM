...
%..............
\subsubsection{Fonction $\Gamma$ et intégrale de \textsc{Gauss}}
...
\todoinline{Modification substantielle pour coller à la définition officielle de la fonction.}
...
%..............
\subsubsection{Bêta, Gamma et Wallis}
...
\todoinline{Indiquer proprement la référence vers le sujet dans la remarque ci-dessous.}

\begin{remarque}
Pour prouver cette relation entre $B$ et $\Gamma$, une autre méthode utilisant la méthode des rectangles est présentée dans le sujet Centrale 1 - MP - 2009.

Le sujet propose également une démonstration de la relation $B(x, 1 - x) = \Gamma(x) \Gamma(1 - x) = \frac{\pi}{\sin(\pi x)}$.
\end{remarque}
