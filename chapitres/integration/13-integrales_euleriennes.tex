...
\item $\phi_j(t) = o_{+\infty}\mathopen{}\left(\frac{1}{t^2}\right)$ et $\phi_j(t) = o_0\mathopen{}\big(t^{a/2-1}\big)$. Ainsi, $\phi_j$ est intégrable sur $\Rp$.
\end{itemize}
\end{itemize}
...
\]
Posons $\fonctionligne[f]{t}{\ln(t) \, \e^{-t}}$. La fonction $f$ est continue sur $\Rpe$, $f(t) \sim_0 \ln(t)$ et $f(t) = o_{+\infty}\mathopen{}\left(\frac{1}{t^2}\right)$. Ainsi, la fonction $f$ est intégrable sur $\Rpe$. \\
