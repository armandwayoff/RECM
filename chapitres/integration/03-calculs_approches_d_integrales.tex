...
\todoarmand{Centrale - PC - 2021\\
Transférer cette ref dans la partie polynômes orthogonaux.\\
Le II.C fait un lien avec la section 5.5 sur les familles de polynômes orthogonaux. \\
...
\todoinline{Ajout de l'encadré exercice à faire pour guider la démonstration de ce résultat}
\begin{exercice}
...
\todoinline{Mettre ici un lien vers un thème sur les polynômes d'interpolation de Lagrange}

\todoarmand{J'ai complété le tableau}

\begin{table}[]
    \centering
    \begin{tabular}{c|c|c|c}
    \textbf{Méthode} & \textbf{Ordre} & \textbf{Vitesse de convergence} & Newton-Cotes \\
    \hline
    À gauche & $1$ & $O(1/p)$ & X\\
    À droite & $1$ & $O(1/p)$ & X\\
    Médians & $1$ & $O(1/p^2)$ & X\\
...
\todoinline{On pourrait ajouter vers le livre Demailly - Analyse numérique et équations différentielles}
