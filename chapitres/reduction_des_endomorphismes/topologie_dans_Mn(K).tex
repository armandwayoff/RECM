...
\begin{preuve}
    ...
    \begin{figure*}[h!]
        ...
        \caption*{\centering Représentation des disques $D(\lambda_i, \rho)$ et des complexes choisis à l'intérieur. Les $\lambda_{4, i}$ sont décalés pour une meilleure lisibilité.}
    \end{figure*}
