\begin{defi}[Partie dense]
    \source{\href{https://www.bibmath.net/dico/index.php?action=affiche&quoi=./d/dense.html}{Partie dense -- \textsf{Bibm@ath.net}}}
...
Ce résultat peut être montré par un argument plus \chevron{mécanique}. \\
