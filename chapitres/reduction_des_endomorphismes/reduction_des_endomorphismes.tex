...
\input{chapitres/reduction_des_endomorphismes/topologie_dans_Mn(K)}
...
\begin{exercice}
    \source{\cite{reduc_des_endo} p. 102}
...
\source{\cite{reduc_des_endo} p.30}
...
\source{\cite{maths-france} Planche no 5. Réduction}
\begin{exercice}
