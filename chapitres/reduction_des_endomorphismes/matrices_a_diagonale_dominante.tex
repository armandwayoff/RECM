...
\begin{preuve}
    ...
    On pose $\displaystyle \left |x_{i_0} \right| \defeq \max_{1 \leqslant i \leqslant n} |x_i|$ \sidenote{Cette méthode revient souvent dans ce genre d'étude.}. La ligne $i_0$ de la relation $AX = 0$ donne
