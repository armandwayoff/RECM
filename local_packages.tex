...
\usepackage{rotating} % pour la page horizontale du diagramme des thèmes
...
\usepackage{ifthen}
\usepackage{xstring} % pour couper les "Théorème de" dans l'index des théorèmes utilisés
