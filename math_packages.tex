...
\newenvironment{preuve}
  {\begin{proof}[$\blacksquare$\ \textbf{\textsc{Démonstration}}]}
  {\end{proof}}
  
\newenvironment{elem_preuve}
  {\begin{proof}[$\blacksquare$\ \textbf{\textsc{Éléments de démonstration}}]}
  {\end{proof}}
...
\newtcolorbox[auto counter,number within=chapter]{defi}[2][]{%
  ...
  title={\textsf{Définition \thetcbcounter\ --\ #2.\ }},  % Fixed title
...
\newtcolorbox[auto counter,number within=chapter]{theo}[2][]{%
  ...
  title={\textsf{Théorème \thetcbcounter\ --\ #2.\ }},  % Fixed title
  attach title to upper, % Move the title into the box
  #1
}
...
\newtcolorbox[auto counter,number within=chapter]{prop}[2][]{%
  ...
  colback=white,
  coltitle={RoyalBlue},  % Black colour for title
  title={\textsf{Proposition \thetcbcounter\ --\ #2.\ }},  % Fixed title
  attach title to upper, % Move the title into the box
  #1
}
...
\newtcolorbox[auto counter,number within=chapter]{corol}[1][]{%
  ...
  colback=white,
  coltitle={RoyalBlue},  % Black colour for title
  title={\textsf{Corollaire \thetcbcounter\ }},  % Fixed title
  attach title to upper, % Move the title into the box
  #1
}
...
\newtcolorbox[auto counter,number within=chapter]{lemme}[1][]{%
  ...
  colback=white,
  coltitle={RoyalBlue},  % Black colour for title
  title={\textsf{Lemme \thetcbcounter\ }},  % Fixed title
  attach title to upper, % Move the title into the box
  #1
}
...
\newtcolorbox[auto counter,number within=chapter]{remarque}[1][]{%
  ...
  title={\textsf{Remarque \thetcbcounter\ }},  % Fixed title
  attach title to upper, % Move the title into the box
  #1
}
...
\newtcolorbox[auto counter,number within=chapter]{exercice}[1][]{%
  ...
  title={\textsf{Exercice \thetcbcounter\ }},  % Fixed title
  attach title to upper, % Move the title into the box
  #1
}
...
\newtcolorbox[auto counter,number within=chapter]{methode}[1][]{%
  ...
  title={\textsf{Méthode \thetcbcounter\ }},  % Fixed title
  attach title to upper, % Move the title into the box
  #1
}