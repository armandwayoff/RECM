...
\input{chapitres/algebre_lineaire_matrices/01-decompositions_matricielles}

% Régler todo & Mise en forme
% \input{chapitres/polynomes/01-interpolation_de_lagrange}
...
% \printbibliography[heading=bibintoc, title=Références] % Ajoute
