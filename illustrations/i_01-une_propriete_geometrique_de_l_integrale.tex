...
\begin{scope}[local bounding box=struct, scale=1]
    ...
    \node at ((2.5, 5) {\footnotesize \contour{blue!15!white}{\color{blue}$\displaystyle \int_{f(a)}^{f(b)} f^{-1}(t)\, \mathrm{d} t$}};
...
,baseline=(struct.south)
    ...
    \node at ((5, 2.5) {\footnotesize \contour{blue!15!white}{\color{blue}$\displaystyle \int_{f(a)}^{f(b)} f^{-1}(t)\, \mathrm{d} t$}};
