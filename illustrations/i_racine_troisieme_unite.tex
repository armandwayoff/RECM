\begin{tikzpicture}[declare function={angle=120;},bullet/.style={inner
    ...
    \draw[-latex] (O) -- (angle:3) node[above] {$\mj$};
    \draw[-latex] (O) -- (2*angle:3) node[below] {$\mj^2 = \overline{\mj}$};
    \draw[-{Latex[bend]}] (angle/2:0.6) node{$\frac{2\pi}{3}$} (0:1) arc(0:angle:1);
    \draw[thick,red] (angle:3) -- (3,0);
