...
% TODO : terminer le graphique selon la remarque ?
\input{chapitres/integration/01-une_propriete_geometrique_de_l_integrale}

% TODO : à relire pour faire des choix, puis à compléter
\input{chapitres/integration/02-lemme_de_lebesgue}

% TODO : à choisir puis à compléter
\input{chapitres/integration/03-sommes_de_riemann_generalisees}

% Alain : doit relire les suivantes
...
\input{chapitres/integration/06-integrales_de_bertrand}
...
% Compile pas avec le fichier suivant : probleme de floats
