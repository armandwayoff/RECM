...
\title[Le Recueil des Exercices Classiques de Mathématiques]{Le Recueil des Exercices Classiques de Mathématiques}
% \subtitle{corrigés}

\author[Armand Wayoff]{Armand Wayoff}
...
\input{chapitres/integration/integration}
...
\printbibliography[heading=bibintoc, title=Référence] % Add the bibliography heading to the ToC, set the title of the bibliography and output the bibliography note
