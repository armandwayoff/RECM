...
% \input{chapitres/determinants/determinants} 
% \input{chapitres/reduction_des_endomorphismes/reduction_des_endomorphismes}
\begin{comment}
...
\printglossary[title=Mathématiciens,nonumberlist]
